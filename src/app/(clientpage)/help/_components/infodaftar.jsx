...
const InformasiPendaftaran = ({helpData, contactUsData, payload, language}) => {
    ...
    return <div className="p-4">
        <h1 className="text-2xl font-bold text-[#00305E] text-center mb-6">
            {helpData[language].title}
        </h1>
        <div className="bg-white p-6 mb-4">
            <h2 className="text-xl font-bold mb-4 text-[#00305E]">{helpData[language].subtitle}</h2>
            <p className="mb-4 text-[#00305E]">{helpData[language].description}</p>
        ...
        <div className="bg-white p-6 mb-4">
            <h2 className="text-xl font-bold mb-4 text-[#00305E]">{helpData[language].registitle}</h2>
            <div className="relative">
                {
                  helpData?.alurpendaftaranimageurl &&
                  <img
                    src={helpData?.alurpendaftaranimageurl}
                    alt="banneraboutus"
