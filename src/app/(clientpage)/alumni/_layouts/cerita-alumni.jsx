              ...
              return (
                <div key={idx}>
                  <div className="p-10 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2">
                    ...
                    <div className="text-[14px] md:text-[20px] lg:text-[25px] xl:text-[18px] place-content-center">
                      <div className="flex">
                        <h1 className="text-[#00305E] font-bold text-[14px] md:text-[20px] lg:text-[25px] xl:text-[25px] pr-2 max-w-1/2">
                          {val?.name}
                        </h1>
                        <h1 className="text-gray-500 font-bold text-[14px] md:text-[20px] lg:text-[25px] xl:text-[25px] w-1/2 content-center">
                          Class of {val?.class}
                        </h1>
                      </div>
                      <div className="xl:mr-10 lg:mr-10 mt-4">
                        <p className="font-semibold text-[12px] md:text-[17px] lg:text-[18px] xl:text-[18px]">
                          {val?.university}, {val?.major}
                        </p>
                        <p className="my-3 xl:mt-3 text-[11px] md:text-[16px] lg:text-[17px] xl:text-[17px]">
                          {val?.testimonies}
                        </p>
                      </div>
                    </div>
