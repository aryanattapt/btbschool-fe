...
const ParentsInformationForm = ({formChangeHandler, datePickerHandler, payload}) => {
    return <>
        ...
        <div className="md:inline-flex">
            ...
            <TextInput className="w-full pr-10 md:pr-0" value={payload.fathername || ''} id="fathername" name="fathername" type="text" onChange={formChangeHandler}/>
        </div>
        <div className="md:inline-flex">
            <div className="mb-2 block w-72">
                <Label htmlFor="fatherbirthplace" value="Birth Place"/>
            </div>
            <Select className="w-full pr-10 md:pr-0" value={payload.fatherbirthplace || ''} id="fatherbirthplace" name="fatherbirthplace" onChange={formChangeHandler}>
        ...
        <div className="md:inline-flex">
            ...
            <TextInput className="w-full pr-10 md:pr-0" value={payload.fatheremail || ''} icon={HiMail} type="email" id="fatheremail" name="fatheremail" onChange={formChangeHandler}/>
        </div>
        <div className="md:inline-flex">
            <div className="mb-2 block w-72">
                <Label htmlFor="fathermaritalstatus" value="Marital Status"/>
            </div>
            <div className="w-full pr-10 md:pr-0 flex items-center gap-2" id="fathermaritalstatus">
        ...
        <div className="md:inline-flex">
            ...
            <TextInput className="w-full pr-10 md:pr-0" value={payload.mothername || ''} id="mothername" name="mothername" type="text" onChange={formChangeHandler}/>
        </div>
        <div className="md:inline-flex">
            <div className="mb-2 block w-72">
                <Label htmlFor="motherbirthplace" value="Birth Place"/>
            </div>
            <Select className="w-full pr-10 md:pr-0" value={payload.motherbirthplace || ''} id="motherbirthplace" name="motherbirthplace" onChange={formChangeHandler}>
                <option value="">Select Birth Place</option>
                <option value="Jakarta">Jakarta</option>
            </Select>
        </div>
        ...
        <div className="md:inline-flex">
            ...
            <TextInput className="w-full pr-10 md:pr-0" value={payload.motheremail || ''} icon={HiMail} id="motheremail" name="motheremail" type="email" onChange={formChangeHandler}/>
        </div>
        <div className="md:inline-flex">
            <div className="mb-2 block w-72">
                <Label htmlFor="mothermaritalstatus" value="Marital Status"/>
            </div>
            <div className="w-full pr-10 md:pr-0 flex items-center gap-2" id="mothermaritalstatus">
