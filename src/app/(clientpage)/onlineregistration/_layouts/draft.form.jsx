...
const DraftNoForm = ({registrationcode, onChange, onPaste}) => {
    return <>
        ...
        <div className="md:inline-flex">
            ...
            <TextInput className="md:w-full pr-10 md:pr-0" id="registrationcode" name="registrationcode" type="text" autoFocus={true} onChange={onChange} onPaste={onPaste} value={registrationcode || ''}/>
        </div>
        {/* <div>
