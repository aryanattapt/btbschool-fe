    ...
    return <>
        <div className="max-w-full grid gap-3 mt-20 md:px-32">
            <div className="inline-flex flex justify-between">
                ...
                <div className="text-[35px] text-[#00305E] font-semibold pr-10 md:pr-0">[{pageNo}/4]</div>
            </div>
            ...
            {/* Page 0 */}
            {
                ...
                <>
                    ...
                    <div>
                        <div>
                            <Radio checked={haveRegisCode == 'true'} id="haveRegisCodeTrue" name="haveRegisCode" value="true" onChange={(e) => setHaveRegiscode(e.target.value)}/>
                            <Label htmlFor="haveRegisCodeTrue">Yes, I have</Label>
                            <Radio checked={haveRegisCode == 'false'} id="haveRegisCodeFalse" name="haveRegisCode" value="false" onChange={(e) => setHaveRegiscode(e.target.value)}/>
                            <Label htmlFor="haveRegisCodeFalse">No</Label>
                        </div>
                    </div>
                    ...
                    <div className="flex">
...

                        {
                            ...
                            <div className="mt-1 py-1.25 px-0.75 items-center text-center w-1/2 md:w-full">
                                <Button type="button" className="w-full lg:w-auto" disabled={isLoading} onClick={setPrevPage}>
                                    Prev
                                </Button>
                            </div> : 
                            <></>
...

                        {
                            ...
                            <div className="mt-1 py-1.25 px-0.75 items-center text-center w-1/2 md:w-full">
                                <Button type="button" className="w-full lg:w-auto" disabled={isLoading} onClick={setNextPage}>
                                    Next
                                </Button>
                            </div> :
                            !isLoading && pageNo == 4 ?
                            <>
                                <div className="mt-1 py-1.25 px-0.75 items-center text-center w-1/2 md:w-full">
                                    <Button type="submit" id="btnSaveAndSend" name="btnSaveAndSend" className="w-full lg:w-auto" disabled={isLoading} onClick={saveAndSendHandler}>
                                        Save And Send
                                    </Button>
                                </div>
                                <div className="mt-1 py-1.25 px-0.75 items-center text-center w-1/2 md:w-full">
                                    <Button type="submit" className="w-full lg:w-auto" disabled={isLoading} onClick={saveAsDraftHandler}>
                                        Save As Draft
                                    </Button>
                                </div>
                            </> :
