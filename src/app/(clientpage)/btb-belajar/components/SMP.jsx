    ...
    <>
      <div className="relative">
        ...
        <div className="my-10 bg-slate-300">
          <div className="flex text-[16px] md:text-[20px] lg:text-[25px] xl:text-[18px] text-justify justify-center items-center py-10 mx-10 text-[#00305E] font-semibold">
        ...
        <div className="activity">
          ...
          {/* DI LUAR RUANGAN */}
          <div className="mt-10 md:mt-20 flex justify-end items-center px-10 md:px-10 lg:px-32 xl:px-32 text-[16px] md:text-[20px] lg:text-[25px] xl:text-[18px]">
            <div className="border-b-8 border-[#EF802B] w-fit"> 
              <h1 className="text-[30px] font-semibold text-[#00305E]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-4 px-10 md:px-10 lg:px-32 xl:px-32 mt-10">
            ...
            <div className="flex">
              <div className="flex flex-wrap content-center justify-center h-full">
                <div className="text-[16px] md:text-[20px] lg:text-[25px] xl:text-[18px] pl-0 xl:pl-5
