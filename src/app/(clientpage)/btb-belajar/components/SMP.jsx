const SMP = ({ btbBelajarData, language }) => {
  return (
    <>
      <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 px-10 md:px-10 lg:px-32 xl:px-32 gap-12">
            <div className="ml-5 text-[14px] md:text-[20px] lg:text-[25px] xl:text-[18px]">
              <ul className="list-disc">
                {btbBelajarData[language]?.smp?.curriculum?.components1?.map(
                  (val) => {
                    return (
                      <li>
            ...
            <div className="ml-5 text-[14px] md:text-[20px] lg:text-[25px] xl:text-[18px]">
              <ul className="list-disc">
                {btbBelajarData[language]?.smp?.curriculum?.components2.map(
                  (val) => {
                    return (
                      <li>
                        <strong>{val.title}</strong>
        ...
        <div className="my-10 bg-slate-300">
          <div className="flex text-[14px] md:text-[20px] lg:text-[25px] xl:text-[18px] text-justify justify-center items-center py-10 mx-10 text-[#00305E] font-semibold whitespace-pre-line">
        ...
        <div className="activity">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-10 md:px-10 lg:px-32 xl:px-32 mt-5 text-[14px] md:text-[20px] lg:text-[25px] xl:text-[18px]">
            <div className="flex">
              <div className="flex flex-wrap content-center justify-center h-full">
                <div className="pr-0 lg:pr-10 text-left text-balance text-[#000000] xl:leading-loose whitespace-pre-line">
              ...
              <div className="flex flex-wrap content-center justify-center h-full">
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <ul className="list-disc">
                        {btbBelajarData[language]?.smp?.programs?.list1?.map(
                          (val) => {
                            return <li>{val}</li>;
                          }
                        )}
                    ...
                    <div>
                      <ul className="list-disc">
                        {btbBelajarData[language]?.smp?.programs?.list2?.map(
                          (val) => {
                            return <li>{val}</li>;
                          }
                        )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-4 px-10 md:px-10 lg:px-32 xl:px-32 mt-10">
            ...
            <div className="flex">
              <div className="flex flex-wrap content-center justify-center h-full">
                <div
                  className="text-[14px] md:text-[20px] lg:text-[25px] xl:text-[18px] pl-0 xl:pl-5
