    ...
    <>
      <div className="relative">
        <div className="mt-10 mb-5">
          <h1 className="md:text-[35px] text-[30px] font-semibold px-10 md:px-10 lg:px-32 xl:px-32 text-[#00305E]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 px-10 md:px-10 lg:px-32 xl:px-32 mt-5 gap-12">
          <div className="text-[#000000] text-[16px] md:text-[20px] lg:text-[25px] xl:text-[18px]">
        ...
        <div className="diLuarKelas">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-4 px-10 md:px-10 lg:px-32 xl:px-32 mt-10 text-[16px] md:text-[20px] lg:text-[25px] xl:text-[18px]">
            <div className="flex">
              <div className="w-full h-full">
                <img
