          ...
          <div className="h-[305px] pl-32 mt-5">
              <div className="flex flex-wrap">
                ...
                <div className="pb-10 pl-10">
                  ...
                  menyesuaikan usia dan tahapan perkembangan anak dengan pengalaman yang sesuai 
                  untuk menantang para murid untuk berkembang. Acara karyawisata ini merupakan 
                  bagian wajib dalam kurikulum dengan biaya yang sudah termasuk dalam struktur pembayaran uang sekolah.
                  </div>
                </div>
              </div>
            </div>
