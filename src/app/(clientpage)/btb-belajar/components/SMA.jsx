    ...
    <>
      <div className="relative">
        <div className="mt-10 mb-5">
            <h1 className="text-[35px] font-bold pl-32 text-[#00305E]">SEKOLAH MENENGAH ATAS</h1>
        </div>
        ...
        <div className="mt-10 mb-5 pl-32">
          ...
          <h1 className="text-balance text-[30px] text-[#000000] mt-5">The International Baccalaureate (IB) Diploma Programme (DP)</h1>
        </div>
        ...
        <div className="my-10 bg-slate-300">
          <div className="flex justify-center text-justify items-center py-10 mx-20 text-[#00305E] leading-loose text-[15px] font-semibold">
            <p className="text-center">Pada dua tahun terakhir mereka di sekolah ini, masing - masing murid ditantang untuk menguasai 
            ...
            dibutuhkan untuk kesuksesan dan keahlian dalam enam bidang pilihan mereka.</p>
          </div>
        </div>
