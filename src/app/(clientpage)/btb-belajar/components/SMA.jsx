  ...
  return (
    <>
      <div className="relative">
        ...
        <div className="text-[#000000] px-10 md:px-10 lg:px-32 xl:px-32 text-[14px] md:text-[20px] lg:text-[25px] xl:text-[20px]">
          <div className="my-5">
