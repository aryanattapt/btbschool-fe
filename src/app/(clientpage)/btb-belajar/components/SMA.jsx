      ...
      <div className="relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="content-center bg-[#EF802B]">
            <h1 className="mt-5 md:mt-0 pl-5 text-[20px] xl:w-[545px] font-semibold text-[#000000]">
        ...
        {/* program kami */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4 px-10 md:px-10 lg:px-32 xl:px-32 mt-10 md:text-[16px] lg:text-[25px] xl:text-[18px]">
          <div className="flex">
            <div className="w-full h-full">
              <img
          ...
          <div className="flex">
            <div className="flex flex-wrap content-center justify-center h-full">
              <div
                className="md:text-[16px] lg:text-[25px] xl:text-[18px] pl-10 lg:pl-10
