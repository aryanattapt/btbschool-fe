...
const BannerForm = () => {
	...
	const onChangePagingHeader = (val) => {
		payload[language]["pagingHeader"]["title"] = val;
		setPayload({ ...payload });
	};
	const onChangeHeaderNavigation = (val) => {
			...
			<NavbarSidebarLayout>
				{isAuthorized ? (
					<div className="max-w-full grid gap-3 md:px-8">
						...
						<FieldTitle>Calendar Data</FieldTitle>
						<div>
							<Button
								color="success"
								onClick={() =>
						...
						<FieldTitle>Banner Setting</FieldTitle>
						...
						<TextInput
							...
							onChange={(e) => onChangePagingHeader(e.target.value)}
						/>

						<FieldTitle>Judul Navigasi</FieldTitle>
						<TextInput
							value={payload[language]["pagingHeader"]["url"][0]["title"]}
							onChange={(e) => onChangeHeaderNavigation(e.target.value)}
						/>
