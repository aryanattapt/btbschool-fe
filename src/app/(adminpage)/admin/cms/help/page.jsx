        ...
        return <NavbarSidebarLayout >
        {
            ...
            <div className="max-w-full grid gap-3 md:px-8">
                ...
                <div>
                    ...
                    <FileInput accept="image/*" multiple={false} id={`alurpendaftaranimage`} ref={fileAlurPendaftaranRef} name={`alurpendaftaranimage`} helperText="Ukuran Maksimum 10 MB. Format Gambar dengan menggunakan aspect ratio wide Misal 1920x1080px" onChange={alurPendaftaranChangeHandler}/>
                </div>
