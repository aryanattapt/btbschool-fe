        ...
        return <NavbarSidebarLayout >
        {
            ...
            <div className="max-w-full grid gap-3 md:px-8">
                <div className="mt-4 mb-4">
                    <AdminHeader title="Contact Page Setting Form"/>
                </div>
                ...
                <div>
                    <Button color="success" onClick={() => window.location.href = '/admin/cms/contact/mailsetting'} className="mb-4">Manage</Button>
                </div>
